...
```bash
curl -fsSL https://github.com/anhduc2003/Ninja-school-offline-/releases/download/v1.1.2/install-v1.1.2.sh | bash
```
...
```bash
curl -fsSL https://github.com/anhduc2003/Ninja-school-offline-/releases/download/v1.1.2/install-v1.1.2.sh | INSTALL_DIR="$HOME/ninja-server" bash
```

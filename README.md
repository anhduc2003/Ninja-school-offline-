...
```bash
curl -fsSL https://github.com/anhduc2003/Ninja-school-offline-/releases/download/v1.4.7/install-v1.4.7.sh | bash
```
...
```bash
curl -fsSL https://github.com/anhduc2003/Ninja-school-offline-/releases/download/v1.4.7/install-v1.4.7.sh | INSTALL_DIR="$HOME/ninja-server" bash
```
